 ...
 * Size: 48 px
 * Bpp: 4
 * Opts: --font assets/fonts/fa-solid-900.ttf --size 48 --bpp 4 --format lvgl --range 0xf008,0xf011,0xf013,0xf015,0xf053,0xf06d,0xf07c,0xf0b2,0xf142,0xf1de,0xf1f8,0xf2c7,0xf55a,0xf863,0xf1eb,0xf796,0xf127,0xf0eb,0xf03a,0xf009 --no-compress -o assets/fonts/fa_icons_48.c
 ******************************************************************************/
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 5595, .adv_w = 768, .box_w = 47, .box_h = 40, .ofs_x = 1, .ofs_y = -2},
    {.bitmap_index = 6535, .adv_w = 480, .box_w = 24, .box_h = 42, .ofs_x = 0, .ofs_y = -3},
    {.bitmap_index = 7039, .adv_w = 672, .box_w = 42, .box_h = 49, .ofs_x = 0, .ofs_y = -6},
    {.bitmap_index = 8068, .adv_w = 864, .box_w = 56, .box_h = 43, .ofs_x = -1, .ofs_y = -3},
    {.bitmap_index = 9272, .adv_w = 768, .box_w = 48, .box_h = 48, .ofs_x = 0, .ofs_y = -6},
    {.bitmap_index = 10424, .adv_w = 576, .box_w = 34, .box_h = 48, .ofs_x = 1, .ofs_y = -6},
    {.bitmap_index = 11240, .adv_w = 960, .box_w = 62, .box_h = 50, .ofs_x = -1, .ofs_y = -7},
    {.bitmap_index = 12790, .adv_w = 192, .box_w = 12, .box_h = 42, .ofs_x = 0, .ofs_y = -3},
    {.bitmap_index = 13042, .adv_w = 768, .box_w = 48, .box_h = 46, .ofs_x = 0, .ofs_y = -5},
    {.bitmap_index = 14146, .adv_w = 960, .box_w = 60, .box_h = 43, .ofs_x = 0, .ofs_y = -4},
    {.bitmap_index = 15436, .adv_w = 672, .box_w = 42, .box_h = 48, .ofs_x = 0, .ofs_y = -6},
    {.bitmap_index = 16444, .adv_w = 480, .box_w = 28, .box_h = 48, .ofs_x = 1, .ofs_y = -6},
    {.bitmap_index = 17116, .adv_w = 864, .box_w = 54, .box_h = 36, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 18088, .adv_w = 768, .box_w = 48, .box_h = 36, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 18952, .adv_w = 768, .box_w = 48, .box_h = 48, .ofs_x = 0, .ofs_y = -6}
};
