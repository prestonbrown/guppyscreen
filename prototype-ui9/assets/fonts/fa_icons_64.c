 ...
 * Size: 64 px
 * Bpp: 4
 * Opts: --font assets/fonts/fa-solid-900.ttf --size 64 --bpp 4 --format lvgl --range 0xf015,0xf1de,0xf576,0xf013,0xf142,0xf07c,0xf55a,0xf06d,0xf0b2,0xf863,0xf011 --no-compress -o assets/fonts/fa_icons_64.c
 ******************************************************************************/
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 1860, .adv_w = 1024, .box_w = 62, .box_h = 64, .ofs_x = 1, .ofs_y = -8},
    {.bitmap_index = 3844, .adv_w = 1152, .box_w = 73, .box_h = 65, .ofs_x = 0, .ofs_y = -8},
    {.bitmap_index = 6217, .adv_w = 896, .box_w = 56, .box_h = 65, .ofs_x = 0, .ofs_y = -8},
    {.bitmap_index = 8037, .adv_w = 1152, .box_w = 74, .box_h = 57, .ofs_x = -1, .ofs_y = -4},
    {.bitmap_index = 10146, .adv_w = 1024, .box_w = 64, .box_h = 64, .ofs_x = 0, .ofs_y = -8},
    {.bitmap_index = 12194, .adv_w = 256, .box_w = 16, .box_h = 55, .ofs_x = 0, .ofs_y = -3},
    {.bitmap_index = 12634, .adv_w = 1024, .box_w = 64, .box_h = 60, .ofs_x = 0, .ofs_y = -6},
    {.bitmap_index = 14554, .adv_w = 1152, .box_w = 72, .box_h = 48, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 16282, .adv_w = 1152, .box_w = 72, .box_h = 64, .ofs_x = 0, .ofs_y = -8},
    {.bitmap_index = 18586, .adv_w = 1024, .box_w = 64, .box_h = 64, .ofs_x = 0, .ofs_y = -8}
};
...
static const uint16_t unicode_list_0[] = {
    0x0, 0x2, 0x4, 0x5c, 0x6b, 0xa1, 0x131, 0x1cd,
    0x549, 0x565, 0x852
};
