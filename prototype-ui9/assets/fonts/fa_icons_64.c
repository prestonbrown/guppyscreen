 ...
 * Size: 64 px
 * Bpp: 4
 * Opts: --font assets/fonts/fa-solid-900.ttf --size 64 --bpp 4 --format lvgl --range 0xf015,0xf1de,0xf576,0xf013,0xf142 --no-compress -o assets/fonts/fa_icons_64.c
 ******************************************************************************/
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 4357, .adv_w = 256, .box_w = 16, .box_h = 55, .ofs_x = 0, .ofs_y = -3},
    {.bitmap_index = 4797, .adv_w = 1024, .box_w = 64, .box_h = 60, .ofs_x = 0, .ofs_y = -6},
    {.bitmap_index = 6717, .adv_w = 1152, .box_w = 72, .box_h = 64, .ofs_x = 0, .ofs_y = -8}
};
